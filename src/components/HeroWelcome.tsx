      ...
      <div className="relative px-8 py-12 sm:px-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-6">
            ...
            <h3 className="text-sm font-semibold text-zinc-100 mb-1">{t('featureDescribe')}</h3>
            <p className="text-sm text-zinc-400">{t('featureDescribeDetail')}</p>
          </div>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-6">
            ...
            <h3 className="text-sm font-semibold text-zinc-100 mb-1">{t('featureSeeIt')}</h3>
            <p className="text-sm text-zinc-400">{t('featureSeeItDetail')}</p>
          </div>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-6">
            ...
            <h3 className="text-sm font-semibold text-zinc-100 mb-1">{t('featureShare')}</h3>
            <p className="text-sm text-zinc-400">{t('featureShareDetail')}</p>
          </div>
        </div>
