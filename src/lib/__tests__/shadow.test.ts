...
import { createShadowStyle, applyShadowToLayers, ShadowCommandOptions, LottieLayerWithStyles } from "../shadow";
...
describe("applyShadowToLayers", () => {
  ...
  it("appends to existing sy array", () => {
    ...
    const layers: LottieLayerWithStyles[] = [{ nm: "L", sy: [existing as any] }];
